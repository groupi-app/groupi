 ...
 */
export function extractWebhookVariables(notification) {
    ...
    const authorName = notification.author?.firstName ??
 ...
 */
export function generateWebhookPayload(notification, webhookFormat, customTemplate // Custom JSON template from database (customTemplate field)
) {
