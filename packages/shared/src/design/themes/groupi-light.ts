...
// ==========================================================================
// SHARED TOKENS (same in light and dark)
// ==========================================================================
...
export const sharedTokens = {
  ...
  radius: {
    shape: {
      subtle: '0.5rem', // 8px - standard
      soft: '1rem', // 16px - cards, containers
      rounded: '1.25rem', // 20px - modals, large elements
      pill: '9999px', // Pill shape
    },
    component: {
      button: '1rem', // 16px - very rounded like Duolingo
      card: '1.25rem', // 20px - friendly, approachable
      input: '0.75rem', // 12px - rounded inputs
      badge: '9999px', // Pill-shaped badges
      avatar: '50%', // Circular avatars
      modal: '1.5rem', // 24px - very soft modals
      tooltip: '0.75rem', // 12px
      dropdown: '1rem', // 16px
      sheet: '1.5rem', // 24px - top corners for sheets
    },
  },
  ...
  zIndex: {
    ...
    lifted: 1, // Slightly above siblings
    float: 2, // Floating above local content
    top: 3, // Topmost in local context
...
export type GroupiLightTheme = typeof groupiLight;
