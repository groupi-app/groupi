...
const errorConfigs: Record<ErrorType, ErrorConfig> = {
  'not-found': {
    ...
    title: 'Not Found',
    defaultMessage:
      "We couldn't find what you're looking for. It may have been deleted or never existed.",
  },
  'access-denied': {
    icon: 'ban',
    ...
    title: 'Access Denied',
    defaultMessage:
      "You don't have permission to view this page. Please contact the organizer if you think this is a mistake.",
  },
  expired: {
    icon: 'time',
...
export function ErrorDisplay({
  ...
  if (compact) {
    return (
      ...
      >
        <div
          className={cn('rounded-full bg-muted p-3 mb-3', config.iconClassName)}
        >
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center justify-center min-h-[60vh] py-12 px-4',
        className
      )}
    >
...
export function NotFoundError({
  ...
  return (
    <ErrorDisplay
      ...
      message={
        message ||
        `This ${resourceType} doesn't exist or may have been deleted.`
      }
      {...props}
    />
  );
...
export function AccessDeniedError({
  ...
  return <ErrorDisplay type='access-denied' message={message} {...props} />;
}
...
export function ExpiredError({
  ...
  return <ErrorDisplay type='expired' message={message} {...props} />;
}
