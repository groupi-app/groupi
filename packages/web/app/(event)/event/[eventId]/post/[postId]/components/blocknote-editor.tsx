  ...
  return (
    <div
      className={cn(
        ...
        isOverLimit && 'bg-bg-error-subtle',
        className
      )}
      data-test={dataTest}
    ...
    >
        ...
        >
          ...
          <SuggestionMenuController
            ...
            suggestionMenuComponent={({
              ...
              <div className='bg-popover border border-border rounded-lg shadow-overlay overflow-hidden min-w-[200px] max-w-[300px]'>
                {items.length === 0 ? (
          ...
          <SuggestionMenuController
            ...
            suggestionMenuComponent={({
              ...
              <div className='bg-popover border border-border rounded-lg shadow-overlay overflow-hidden min-w-[200px] max-w-[300px] max-h-[300px] overflow-y-auto'>
                {items.length === 0 ? (
                  <div className='px-3 py-2 text-sm text-muted-foreground'>
                    No commands found
                  </div>
      ...
      {isOverLimit && (
        <div className='px-3 pb-2 text-sm text-error'>Content is too long</div>
      )}
    </div>
  );
}
