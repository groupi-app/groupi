...
export function DateCard({
  ...
  return (
    <Dialog>
      ...
      >
        <div className='w-full md:max-w-lg rounded-card border border-border shadow-raised py-4 px-4 hover:bg-accent/80 hover:shadow-floating transition-all cursor-pointer'>
