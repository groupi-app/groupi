...
describe("useNotifications hooks", () => {
  ...
  describe("useMarkNotificationAsRead", () => {
    test("should mark notification as read successfully", async () => {
      ...
      expect(mockMarkNotificationAsRead).toHaveBeenCalledWith("test-notification-id");
  ...
  describe("useMarkNotificationAsUnread", () => {
    test("should mark notification as unread successfully", async () => {
      ...
      const { useMarkNotificationAsUnread } = await import("./use-notifications");
      ...
      expect(mockMarkNotificationAsUnread).toHaveBeenCalledWith("test-notification-id");
  ...
  describe("useDeleteNotification", () => {
    test("should delete notification successfully", async () => {
      ...
      expect(mockDeleteNotification).toHaveBeenCalledWith("test-notification-id");
    });
  ...
  describe("useMarkAllNotificationsAsRead", () => {
    test("should mark all notifications as read successfully", async () => {
      ...
      const { useMarkAllNotificationsAsRead } = await import("./use-notifications");
