...
export function useTransientForm<TFieldValues extends FieldValues>({
  ...
  const form = useForm<TFieldValues>({
    // @ts-expect-error - zodResolver generic inference is complex but functionally correct
  ...
  return {
    // Type cast required due to react-hook-form generic inference complexities
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    form: form as any,
    resetForm,
  };
