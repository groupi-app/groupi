...
interface GroupiMarkProps {
  size?: number;
  color?: string;
}

export function GroupiMark({ size = 64, color = '#8200AD' }: GroupiMarkProps) {
  const height = size * (237 / 203);

  return (
    <Svg width={size} height={height} viewBox='-6 -6 203 237' fill='none'>
