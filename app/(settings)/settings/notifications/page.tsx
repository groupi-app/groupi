...
export default async function NotificationSettings() {
  ...
  if (!settingsRes.success) {
    return <div className="text-red-500">Failed to load settings: {settingsRes.error}</div>;
  }
  ...
  return (
    <div className="md:container max-w-2xl mx-auto py-8">
      ...
      <p className="mb-6 text-muted-foreground">Manage your notification preferences.</p>
